...
{
    return array(
        'DisplayName' => 'Smilepay 7-11 ibon',
        'APIVersion' => '1.1',
    );
}
...
function smilepay_ibon_link($params)
{
    ...
    $returnUrl = $params['systemurl'] . '/modules/gateways/callback/smilepay_ibon.php';
...
function smilepay_ibon_refund($params)
{
    return array(
        'status' => 'error',
        'rawdata' => '暫不支援退款功能'
